    ...
    <header className="sticky top-0 z-10 border-b border-[var(--color-hairline)] bg-[var(--color-canvas)]/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-4 px-5 py-3">
        <div className="flex items-center gap-2.5">
          <span className="grid h-8 w-8 place-items-center rounded-[9px] bg-[var(--color-accent)] text-[15px] font-bold text-white">B</span>
          <div className="leading-tight">
            <div className="text-[15px] font-semibold">Buffett Daily</div>
